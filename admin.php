...
<body>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-left menu-1">
                            <ul>
                                ...
                                <li class="active"><a href="admin.php">USUARIOS</a></li>
        ...
        <table class="table table-striped tblUsu table-hover justify-content-center align-items-center text-center" style="width:70%; margin:0 auto;border-style: solid; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:black">
            ...
            while ($mostrar = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td style="color: black;"><?php echo $mostrar['email']; ?></td>
                    <td style="color: black;"><?php echo $mostrar['contra']; ?></td>
                    <td style="color: black;"><?php echo $mostrar['rol']; ?></td>
                    <td>
                        <a href=" editarUser.php?id=<?php echo $mostrar['id']; ?>" class="btn btn-success editbtn" data-dismiss="modal" data-bs-toggle="modal" data-bs-target="#editarUsu">Editar</a><!-- ----data-toggle="modal" data-target="editarUsu""-->
                        <a href="eliminarUser.php?id=<?php echo $mostrar['id']; ?>" class="btn btn-danger button-red table__item__link">Eliminar</a>
                    </td>
                </tr>
            <?php
            }
            ...
            <div class="modal-content">
                ...
                <form action="insertarUser.php" method="post">
                    <div class="modal-body" style="color: black;">
                        ...
                        <div class="form-group">
                            <label for="">Contraseña: </label>
                            <input type="text" name="contrasenia" id="contrasenia" class="form-control" placeholder="Password" required>
                        </div>
    ...
    <script src="confirmacionUser.js"></script>
    <script>
